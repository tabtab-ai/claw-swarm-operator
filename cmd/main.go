...
import (
	...
	"github.com/tabtab-ai/claw-swarm-operator/internal/controller"
	"github.com/tabtab-ai/claw-swarm-operator/pkg/claw"
...
func main() {
	...
	fs := flag.NewFlagSet("claw-controller", flag.ExitOnError)
	...
	labelSelector, _ := labels.Parse(claw.TAB_CLAW)
	...
	if cfg.WatchNamespace != "" {
		cacheOptions.DefaultNamespaces = map[string]cache.Config{
			strings.TrimSpace(cfg.WatchNamespace): {},
		}
	}
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "b0681ff6.tabtabai.com",
		Cache:                  cacheOptions,
